...
def main(argv=None):
    ...
    ensemble = tc.dataset.create_canonical_ensemble(conv_cell, calc, replace_element, new_elements, args.supercell_size, endpoint_energies, supercell_diag, snapshots, reuse_site_map=True)
